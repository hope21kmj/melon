...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Meloncoin " + FormatFullVersion();
...
//    {"meloncoin.com", "dnsseed.meloncoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
//    {"meloncoin.com", "testnet-seed.meloncoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Meloncoin is probably already running."), addrBind.ToString().c_str());
        else
